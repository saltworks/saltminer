        ...
        <div v-if="!isDisabled" class="issue-top_right">
          <div @click="removeIssue">
            <ButtonComponent
              ...
              size="medium"
              :disabled="isDisabled || notSaved || pageLoading || actionRoleRestricted('MarkRemoved')"
            />
          </div>
          ...
          <div @click="cloneIssue">
            <ButtonComponent
              ...
              theme="primary"
              size="medium"
              :disabled="isDisabled || notSaved || pageLoading || actionRoleRestricted('Clone')"
            />
          </div>
          <div @click="saveIssue()">
            <ButtonComponent
...
export default{
  ...
  methods: {
   ...
   async getEngagement(callback) {
    ...
    async cloneIssue() {
      if (this.notSaved || this.pageLoading || this.actionRoleRestricted('Clone')) return;
    ...
    async removeIssue() {
      if (this.notSaved || this.pageLoading || this.actionRoleRestricted('MarkRemoved')) return;
