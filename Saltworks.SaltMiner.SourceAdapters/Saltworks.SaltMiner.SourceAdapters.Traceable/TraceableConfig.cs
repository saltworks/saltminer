...
namespace Saltworks.SaltMiner.SourceAdapters.Traceable
{
    ...
    public class TraceableConfig : SourceAdapterConfig
    {
        public TraceableConfig()
        {
        ...
        public override void Validate()
        {
            ...
            if (myFields.Any(f => missingFields.Contains(f)))
                throw new SourceConfigurationException($"'{nameof(TraceableConfig)}' is missing values. {missingFields}");
        }
