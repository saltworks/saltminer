...
/// 
/// This is a template.  Do not reference this class directly. Copy and modify as needed for specific debugging scenarios, removing this comment in those scenarios.
/// 
...
public static class AiHelper
{
    ...
    private const string ElasticsearchUrl = "<url here>";
    private const string ElasticsearchUser = "<username or elastic>";
    private const string ElasticsearchPassword = "<password here>";
