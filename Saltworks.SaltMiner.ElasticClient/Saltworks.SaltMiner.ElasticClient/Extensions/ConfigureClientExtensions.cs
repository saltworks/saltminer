...
using Saltworks.SaltMiner.ElasticClient.NestClient;
using System;
...
public static class ConfigureClientExtensions
{
    ...
    public static void Configure(Microsoft.AspNetCore.Builder.IApplicationBuilder app, ILogger<NestClient.NestClient> logger)
    {
        app.UseNestClient();
    }
