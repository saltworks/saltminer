...
[Auth]
[ApiController]
public class QueueAssetController(ILogger<QueueAssetController> logger, QueueAssetContext context) : ApiControllerBase(context, logger)
{
    ...
    public ActionResult<DataResponse<QueueAsset>> Search([FromBody] SearchRequest search)
    {
        ...
        return Ok(Context.Search<QueueAsset>(QueueAssetIndex, search));
    }
}
