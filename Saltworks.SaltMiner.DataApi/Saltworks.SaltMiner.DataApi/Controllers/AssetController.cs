...
[Auth]
[ApiController]
public class AssetController(AssetContext context, ILogger<AssetController> logger) : ApiControllerBase(context, logger)
{
    ...
    public ActionResult<DataResponse<Asset>> Search([FromBody] SearchRequest search)
    {
        ...
        return Ok(Context.Search<Asset>(Asset.GenerateIndex(search.AssetType, search.SourceType, search.Instance), search));
    }
