...
public class QueueIssueContext(ApiConfig config, IDataRepo dataRepository, IElasticClientFactory factory, ILogger<QueueIssueContext> logger) : ContextBase(config, dataRepository, factory, logger)
{
