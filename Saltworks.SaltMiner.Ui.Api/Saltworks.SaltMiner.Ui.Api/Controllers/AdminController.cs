...
public class AdminController(AdminContext context, ILogger<AdminController> logger) : ApiControllerBase(context, logger)
{
    ...
    {
        Logger.LogInformation("Add/update Config action called");
        return Accepted(Context.ConfigAddUpdate(request));
    }
    ...
    public ActionResult<UiDataItemResponse<Config>> GetConfig(string id)
    {
        ...
        return Ok(Context.ConfigGet(id));
    }
    ...
    [HttpGet("configuration/section/{section}/{subsection?}")]
    public ActionResult<DataResponse<Config>> GetConfigurationSection(string section, string subsection = "")
    {
        Logger.LogInformation("GetSection action called");
        return Ok(Context.ConfigGetBySectionSubsection(section, subsection));
    }
    ...
    public ActionResult<UiNoDataResponse> DeleteConfig(string id)
    {
        ...
        return Ok(Context.ConfigDelete(id));
    }
