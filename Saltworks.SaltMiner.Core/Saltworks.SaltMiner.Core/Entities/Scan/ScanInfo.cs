...
public class ScanInfo : IScanInfoBase, IIssueCounts
{
    ...
    /// <summary>
    /// Gets or sets Product Version.  This is the version of the product running the scan, if available.  SaltMiner does NOT use this property.
    /// </summary>
    ...
    /// <summary>
    /// Rulepacks used in this scan (for sources that provide this information).  SaltMiner does NOT use this property.
    /// </summary>
    public List<RulepackItem> Rulepacks { get; set; } = new();

    /// <summary>
    /// The number of lines scanned in the code.  SaltMiner does NOT use this property.
    /// </summary>
...
{ 
    ...
    /// <summary>
    /// Gets or sets Product Version of the scanner used to run the scan. EG) SCA. SaltMiner does NOT use this property.
    /// </summary>
    public string ProductVersion { get; set; }
