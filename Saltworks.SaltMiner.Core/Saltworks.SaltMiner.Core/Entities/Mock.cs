...
public static class Mock
{
    ...
    public static QueueAsset QueueAsset(string qScanId=null, EngagementInfo engagementInfo=null) => new()
    {
        Saltminer = new()
        {
            Asset = new()
    ...
    /// </summary>
    /// <remarks>Attempts will be made to populate ALL fields, but some may be missed as time goes by and new ones are added</remarks>
    public static QueueIssue QueueIssue(string qScanId=null, string qAssetId=null, EngagementInfo engagementInfo=null) => new()
    {
        Saltminer = new()
        {
    ...
    /// </summary>
    /// <remarks>Attempts will be made to populate ALL fields, but some may be missed as time goes by and new ones are added</remarks>
    public static QueueScan QueueScan(EngagementInfo engagementInfo = null) => new()
    {
        Timestamp = DateTime.UtcNow,
        LastUpdated = DateTime.UtcNow,
        Saltminer = new()
